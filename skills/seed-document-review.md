---
name: seed-document-review
description: Use when reviewing design documents, research findings, specs, or proposals before they advance to the next phase, when a formula step references /seed-document-review
...
- Formula steps referencing `/seed-document-review`
...
**When NOT to use:**
- Code review — use `/seed-code-review` instead

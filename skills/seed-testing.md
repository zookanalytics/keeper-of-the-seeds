---
name: seed-testing
description: Use when writing and running tests for implemented code, when a formula step references /seed-testing
...
Activated by formula steps referencing `/seed-testing`. Typically the test step in `standard-feature` and similar workflows. Governs how an agent writes and runs tests for implemented code.
